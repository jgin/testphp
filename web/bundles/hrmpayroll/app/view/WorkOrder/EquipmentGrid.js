 ...
 */
Ext.define('sisprod.view.WorkOrder.EquipmentGrid',{
    ...
    id: 'equipmentGrid',
    store: Ext.StoreManager.lookup('equipmentTypeStoreTplGrid'),
    height: 200,
    autoScroll:true,
            ...
            },
            {
                ...
                handler:function(){
                    ...
                    if(record){
                        ...
                        if(pos<0){
                            var model = Ext.create('sisprod.model.WorkOrderScheduledEquipmentModel',{
