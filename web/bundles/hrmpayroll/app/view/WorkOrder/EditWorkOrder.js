...
Ext.define('sisprod.view.WorkOrder.EditWorkOrder', {
    extend: 'sisprod.view.base.BaseDataWindow',
    
    alias: 'widget.editWorkOrder',
...
//                    labelWidth:100,
    ...
    afterrender: function(){
        ...
        //
        var controllerName = sisprod.getApplication().getControllerName('SchedulingWorkRequest');
        var controller = sisprod.getApplication().getController(controllerName);
        controller.loadWorkTemplateActivities(me.workOrderActivities, me);
        controller.loadWorkTemplateProducts(me.workOrderScheduledProducts, me);
        controller.loadWorkTemplateEquipments(me.workOrderScheduledEquipments, me);
        //
        me.down('#schedulingActivityOtGrid').updateHours();
//        me.callParent(arguments);
    },
            ...
            items: [
                {
                    ...
                    name: 'idWorkOrder',
                    id: 'idWorkOrder',
                    value: me.workOrder['idWorkOrder']
                },
                {
                    xtype: 'hiddenfield',
                    name: 'idWorkRequest',
                    id: 'idWorkRequest',
                    value: me.workOrder['workRequest']['idWorkRequest']
                },
                {
                    ...
                    items: [
                        {
                            ...
                            readOnly: true,
                            value: me.workOrder['workRequest']['workRequestFullNumber']
                        },
                        {
                            xtype: 'textfield',
                            name: 'locationName',
                            ...
                            readOnly: true,
                            margin: '0 0 0 10',
                            value: me.workOrder['workRequest']['location']['locationName']
                        }
                    ]
                },
                {
                    ...
                    items: [
                        {
                            ...
                            readOnly: true,
                            value: me.workOrder['workRequest']['workRequestSource']['workRequestSourceName']
                        },
                        {
                            xtype: 'textfield',
                            name: 'equipmentName',
                            ...
                            readOnly: true,
                            margin: '0 0 0 10',
                            value: me.workOrder['workRequest']['equipment']['equipmentName']
                        }
                    ]
                },
                {
...
//                            anchor: '60%',
                            ...
                            readOnly: true,
                            editable: false,
                            value: me.workOrder['sector']['idSector']
                        },
                        {
...
//                                labelWidth: 120,
                                ...
                                value: new Ext.create(sisprod.getApplication().getModelName('TaskScheduler'),{
                                    idTaskScheduler: me.workOrder['taskScheduler']['idTaskScheduler'],
                                    personFullName: me.workOrder['taskScheduler']['employee']['person']['personFullName'],
                                    fullDocumentNumber: me.workOrder['taskScheduler']['employee']['person']['fullDocumentNumber']
                                })
                            }
                        }
                    ]
...
//                            anchor: '65%',
        ...
        //                    labelWidth: 120,
                            ...
                            readOnly: true,
                            editable: false,
                            value: me.workOrder['workCategoryDetail']['workCategory']['idWorkCategory']
                        },
                        {
                            xtype: 'sensitivecombocontainer',
//                            anchor: '80%',
                            ...
                            sensitiveComboBoxOptions:{
                                ...
                                value: new Ext.create(sisprod.getApplication().getModelName('WorkCategoryDetail'),{
                                    idWorkCategoryDetail: me.workOrder['workCategoryDetail']['idWorkCategoryDetail'],
                                    idWorkCategory: me.workOrder['workCategoryDetail']['workCategory']['idWorkCategory'],
                                    workCategoryName: me.workOrder['workCategoryDetail']['workCategory']['workCategoryName'],
                                    workCategoryDetailName: me.workOrder['workCategoryDetail']['workCategoryDetailName']
                                })
                            }
                        }
                    ]
                },
                {
                    ...
                    readOnly: true,
                    anchor: '30%',
                    value: me.workOrder['attentionMaximumDate'],
                    listeners: {
                    ...
                    items: [
                        {
                            ...
                            id: 'description',
                            allowBlank: false,
                            value: me.workOrder['description']
                        }
                    ]
                }
            ]
    ...
    getScheduleItems: function(){
        ...
        var items = {};
        //
        var ownResources = me.workOrder['ownResources'];
        var quadrilleData;
        if(ownResources){
            if(me.additionalData['quadrille']){
                quadrilleData = new Ext.create(sisprod.getApplication().getModelName('Quadrille'),{
                    idQuadrille: me.additionalData['quadrille']['idQuadrille'],
                    quadrilleName: me.additionalData['quadrille']['quadrilleName']
                });
            }
        }
        var workShopData = me.workOrder['workShop'];
        if(workShopData){
            workShopData = new Ext.create(sisprod.getApplication().getModelName('WorkShop'),{
                idWorkShop: me.workOrder['workShop']['idWorkShop'],
                workShopName: me.workOrder['workShop']['workShopName']
            });
        }
        var workShopCoordinatorData = me.workOrder['workShopCoordinator'];
        if(workShopCoordinatorData){
            workShopCoordinatorData = new Ext.create(sisprod.getApplication().getModelName('WorkShopCoordinator'),{
                idWorkShopCoordinator: me.workOrder['workShopCoordinator']['idWorkShopCoordinator'],
                personFullName: me.workOrder['workShopCoordinator']['employee']['person']['personFullName'],
                fullDocumentNumber: me.workOrder['workShopCoordinator']['employee']['person']['fullDocumentNumber']
            });
        }
        //
        items = {
...
//                            allowBlank: false,
                            requiredForWorkOrder: true,
                            readOnly: true,
                            value: me.workOrder['scheduledStartDate'],
                            maxValue: me.workOrder['attentionMaximumDate'],
                            listeners: {
                                change: function(field, newValue, oldValue, eventOptions){
...
//                            allowBlank: false,
                            ...
                            margin: '0 0 0 10',
                            readOnly: true,
                            value: me.workOrder['scheduledEndDate'],
                            minValue: me.workOrder['scheduledStartDate']
                        }
                    ]
                }
            ]
    ...
    getWorkServiceItems: function(){
        ...
        var ownResources = me.workOrder['ownResources'];
        if(!ownResources) {
            var supplierId = me.additionalData['supplier']['idSupplier'];
            var serviceOrderNumber = me.additionalData['serviceOrderNumber'];
        }
...
//            me.down('#scheduledEndDate').enable();
            me.down('button[action=generateOrder]').show();
        }
        else{
...
//            me.down('#scheduledEndDate').disable();
            me.down('button[action=generateOrder]').hide();
        }
    }
});