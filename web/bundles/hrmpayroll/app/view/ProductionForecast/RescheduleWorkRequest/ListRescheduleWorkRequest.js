...
Ext.define('sisprod.view.RescheduleWorkRequest.ListRescheduleWorkRequest', {
   ...
   alias: 'widget.listRescheduleWorkRequest',
   ...
   listTitle: 'Work Requests Expired List',
   messages: {
       headers: {
           idWorkRequest: 'ID',
           lotName: 'Lot',
       ...
       var modelName = sisprod.getApplication().getModelName('WorkRequest');
        me.gridOptions = {
            ...
            topBarButtons: [
                {
                    xtype: 'button',
                    text: me.messages.rescheduleText,
                    iconCls: 'reschedule',
                    action: 'reschedule'
                }
            ]
