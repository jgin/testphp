 ...
 */
Ext.define('sisprod.view.ApprovedDeferredProduction.UpdateApprovedDeferredProduction', {
    extend: 'sisprod.view.base.BaseDataWindow',
    alias: 'widget.updateApprovedDeferredProduction',
    ...
    title: 'Update Deferred Production',
    modal: true,
    width: 730,
    layout : 'anchor',
            ...
            items: [
                {
                    ...
                    items : [
                        {
                            xtype: 'hiddenfield',
                            name: 'idDeferredProduction',
                            id: 'idDeferredProduction'
                        },
                        {
                            xtype: 'textfield',
                            grow: true,
