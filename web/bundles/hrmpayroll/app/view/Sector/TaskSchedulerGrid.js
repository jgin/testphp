...
Ext.define('sisprod.view.Sector.TaskSchedulerGrid',{
    ...
    messages: {
        ...
        validation: {
            alertTitle: 'Message',
            repeatedItem: 'The selected employee has been added before!',
    ...
    checkRepeatedValue: function(value, gridStore, comboStore){
        ...
        if(Ext.isDefined(value) && value!==null && value!==''){
            ...
            if(Ext.isDefined(searchResult) && searchResult!==null){
                Ext.Msg.alert(me.messages.validation.alertTitle, me.messages.validation.repeatedItem);
                return;
            }
            else{
