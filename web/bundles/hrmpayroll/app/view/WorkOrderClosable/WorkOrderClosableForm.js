...
Ext.define('sisprod.view.WorkOrderClosable.WorkOrderClosableForm', {
    extend: 'sisprod.view.base.BaseDataWindow',
    
    alias: 'widget.workOrderClosableForm',
    ...
    messages: {
        labels: {
            ...
            lot: 'lot',
            sector: 'Sector',
            equimentType: 'Equiment Type',
            equiment: 'Equiment',
            reasonOder: 'Reason Order'
        },
        validations: {
    ...
    initComponent: function(){
        ...
        if(!me.record.data.isDirectWorkOrder){
            mainDataItems.push(me.getMainDataItems());
        }else{
            mainDataItems.push(me.getGeneralDirectDataItems());
        }
...
//        },
        ...
        me.formOptions = {
            ...
            buttons: [
                ...
                {
                    text: me.messages.labels.saveObservation,
...
//    },
    ...
    getGeneralDirectDataItems: function(){
        var me = this;
                    ...
                    items: [
                        {
                            xtype: 'textfield',
                            readOnly: true,
                            fieldLabel: me.messages.labels.workOrderNumber,
...
//                            fieldLabel : me.messages.labels.equipmentType,
                            fieldLabel : me.messages.labels.equimentType,
//                            labelWidth: 120,
                        ...
                        },
                        {
                            ...
                            name: 'idEquipment',
                            flex: 4,
                            fieldLabel: me.messages.labels.equiment
                        }
                    ]
                },
                {
                ...
                },
                {
                    ...
                    labelWidth: 120,
                    anchor: '45%',
                    fieldLabel: me.messages.labels.reasonOder,
                    readOnly: true
                },
                {
                    xtype:'fieldset',
