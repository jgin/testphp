 ...
 */
Ext.define('sisprod.view.WorkTemplate.ActivityOtGrid',{
...
//            forceSelection : true,
        ...
        },
        {
            ...
            handler:function(){
                    ...
                    var activityOtGrid;
                    activityOtGrid = Ext.getCmp('activityOtGrid');
        ...
        }, 
        {
            ...
            flex:1,
            handler:function(){
                var grid =Ext.getCmp('activityOtGrid');
                var record=grid.getSelectionModel().getSelection()[0];
                if(Ext.isDefined(record)){
                    var store=grid.getStore();
                    var pos = store.find('idActivityOt',record.raw.idActivityOt);            
                    store.removeAt(pos);
                    me.updateHours();
                }else{
                    Ext.Msg.alert(me.messages.alertCaption,me.messages.noActivityOtSelectToRemoveError);
                }
            }
        }
    ];
