 ...
 */
Ext.define('sisprod.view.Reports.EfficiencyEstimateDurationWorkReports', {
...
//    width: 300,
    ...
    messages: {
        reportTitle: 'Efficiency - Estimate Duration Work',
        labels: {
            lot: 'Lot',
...
//                            var dateFrom=Ext.Date.parse(Ext.getCmp("dateFromtabReportsWorkRequestStatusHistory").getValue(),'Y-m-d');
                            var reportLink = Ext.String.format("reports.htm?reportName=work_order_efficiency_estimated_duration_work.rptdesign&rp_StartDate={0}"+
