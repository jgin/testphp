 ...
 */
Ext.define('sisprod.view.Reports.EfficacyWorkRequestBacklogDaysReports', {
...
//    width: 300,
    ...
    messages: {
        reportTitle: 'Efficacy - Work Request Backlog Days',
        labels: {
            lot: 'Lot',
...
//                            var dateFrom=Ext.Date.parse(Ext.getCmp("dateFromtabReportsWorkRequestStatusHistory").getValue(),'Y-m-d');
                            var reportLink = Ext.String.format("reports.htm?reportName=work_request_indicator_rescheduled.rptdesign&rp_StartDate={0}"+
