 ...
 */
Ext.define('sisprod.view.Reports.ManagementQuadrilleWorkReports', {
    extend: 'sisprod.view.base.TabPanelItem',
    alias: 'widget.managementQuadrilleWorkReports',
    closable: true,
    height: 300,
    messages: {
        reportTitle: 'Management Quadrille Work Report',
        messageText: 'Message',
        labels: {
            lot: 'Lot',
            ...
            buttons:[
                {
                    ...
                    handler: function(){
                        if(form.getForm().isValid()){
                            ...
                            var reportLink = Ext.String.format("reports.htm?reportName=management_quadrille_work.rptdesign&id_lot={0}"+
