 ...
 */
Ext.define('sisprod.view.Reports.EfficiencyManHoursReports', {
...
//    width: 300,
    ...
    messages: {
        reportTitle: 'Efficiency - Estimate Man Hours',
        labels: {
            lot: 'Lot',
...
//                            var dateFrom=Ext.Date.parse(Ext.getCmp("dateFromtabReportsWorkRequestStatusHistory").getValue(),'Y-m-d');
                            var reportLink = Ext.String.format("reports.htm?reportName=work_order_efficiency_man_hours.rptdesign&rp_StartDate={0}"+
