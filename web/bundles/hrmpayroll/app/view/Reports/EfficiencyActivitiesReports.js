 ...
 */
Ext.define('sisprod.view.Reports.EfficiencyActivitiesReports', {
...
//    width: 300,
    ...
    messages: {
        reportTitle: 'Efficiency - Activities',
        labels: {
            lot: 'Lot',
...
//                            var dateFrom=Ext.Date.parse(Ext.getCmp("dateFromtabReportsWorkRequestStatusHistory").getValue(),'Y-m-d');
                            var reportLink = Ext.String.format("reports.htm?reportName=work_order_efficiency_activities.rptdesign&rp_StartDate={0}"+
