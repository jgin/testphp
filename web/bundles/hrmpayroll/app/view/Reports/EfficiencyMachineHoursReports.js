 ...
 */
Ext.define('sisprod.view.Reports.EfficiencyMachineHoursReports', {
...
//    width: 300,
    ...
    messages: {
        reportTitle: 'Efficiency - Estimate Machine Hours',
        labels: {
            lot: 'Lot',
...
//                            var dateFrom=Ext.Date.parse(Ext.getCmp("dateFromtabReportsWorkRequestStatusHistory").getValue(),'Y-m-d');
                            var reportLink = Ext.String.format("reports.htm?reportName=work_order_efficiency_machine_hours.rptdesign&rp_StartDate={0}"+
