 ...
 */
Ext.define('sisprod.view.TestProgram.UpdateTestProgram', {
    extend: 'sisprod.view.base.BaseDataWindow',
    alias: 'widget.updateTestProgram',
    ...
    messages: {
        ...
        msgButtonSaveChanges: 'Save Changes'
    },
    
    title: 'Edit Testing Program',
    modal: true,
    width: 650,
    layout: 'fit',
    hasButtons: false,
    ...
    initComponent: function(){
        ...
        if(me.showSaveChanges){
            buttons.push({
                id: 'saveChanges',
                text: me.messages.msgButtonSaveChanges,
                iconCls: 'save',
                action: 'saveChanges'
            });
        }
