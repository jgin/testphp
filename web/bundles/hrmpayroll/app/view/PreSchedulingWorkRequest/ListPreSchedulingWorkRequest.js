...
Ext.define('sisprod.view.PreSchedulingWorkRequest.ListPreSchedulingWorkRequest', {
   ...
   alias: 'widget.listPreSchedulingWorkRequest',
   ...
   listTitle: 'Work Requests For Pre-Scheduling',
   messages: {
       headers: {
           idWorkRequest: 'ID',
           lotName: 'Lot',
       ...
       var modelName = sisprod.getApplication().getModelName('WorkRequest');
        me.gridOptions = {
            ...
            topBarButtons: [
                {
                    xtype: 'button',
                    text: me.messages.preSchedule,
                    iconCls: 'viewDetail',
                    action: 'showPreSchedulingWindow'
                },
                {
                    xtype: 'button',
                    text: me.messages.taskDescriptionDetail,
                    iconCls: 'viewDetail',
                    action: 'viewDetail'
                }
            ]
