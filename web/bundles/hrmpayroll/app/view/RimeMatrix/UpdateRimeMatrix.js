...
Ext.define('sisprod.view.RimeMatrix.UpdateRimeMatrix', {
    extend: 'sisprod.view.base.BaseDataWindow',
    
    alias: 'widget.updateRimeMatrix',
    
    require: [
        'sisprod.view.base.BaseDataWindow'
    ],
    
    title: 'Edit RIME Matrix',
    messages: {
        labels: {
    ...
    initComponent: function(){
        ...
        var formItems = [
            ...
            {
                xtype: 'hiddenfield',
                name: 'idRimeMatrixDetail',
                id: 'idRimeMatrixDetail'
            },
            {
                xtype:'fieldset',
                columnWidth: 0.5,
...
//    },
    ...
    getCriticalityLevelItems: function(){
        var me = this;
        var rows = [];
        Ext.Array.each(me.formData.criticalityCriterias, function(value, index, itself) {
            if(value){
                var row = Ext.create('sisprod.model.CriteriaFactorLevelModel',
                {
                    idCriteriaFactorLevel: value['idCriteriaFactorLevel'],
...
//        });
    ...
    getConsequenceLevelItems: function(){
        var me = this;
        var rows = [];
        Ext.Array.each(me.formData.consequenceCriterias, function(value, index, itself) {
            if(value){
                var row = Ext.create('sisprod.model.CriteriaFactorLevelModel',
                {
                    idCriteriaFactorLevel: value['idCriteriaFactorLevel'],
...
//                async: false,
    ...
    getRiskCriteria: function(){
        ...
        //
        var idCriteriaLevel = me.down('#idCriteriaLevel');
        idCriteriaLevel.setValue(maximumData['idCriteriaLevel']);
        //
