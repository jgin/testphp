...
Ext.define('sisprod.view.WorkRequest.WorkRequestReferenceFilesWindow', {
    extend: 'sisprod.view.base.BaseDataWindow',
    
    alias: 'widget.workRequestReferenceFilesWindow',
...
//                                    buttonText: 'Select...',
                ...
                Ext.create('sisprod.view.WorkRequest.ReferenceFilesGrid', { idWorkRequest: me.data['idWorkRequest'] })
            ],
            buttons: [
                {
