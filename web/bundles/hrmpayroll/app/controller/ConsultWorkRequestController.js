 ...
 */
Ext.define('sisprod.controller.ConsultWorkRequestController', {
...
//           }
    ...
    observeOrder:function(button){
        ...
        Ext.Msg.show({
            title: me.messages.titleObserve,            msg: Ext.String.format(me.messages.confirmText, fullNumberWorkOrder ),
    ...
    beforeSave: function(values){
        ...
        var idWorkOrder = this.getConsultWorkRequestForm().getRecord().data.idWorkOrder;
        var ownResources = this.getConsultWorkRequestForm().getRecord().data.ownResources;
        var scheduledActivityStore = Ext.getCmp('activityClosableOtGrid').getStore();
        var activityStore = Ext.getCmp('newActivityGrid').getStore();
        var scheduledProductStore = Ext.getCmp('workOrderScheduledProductGrid').getStore(); 
        var productStore = Ext.getCmp('workOrderProductGrid').getStore(); 
...
//        var idWorkOrder = this.getConsultWorkRequestForm().getRecord().data.idOWrkOrder;
...
//        this.saveOrder(button, 'rest/workOrder/partialClosable.htm');
    ...
    completeClosable: function(button){
        var fullNumberWorkOrder = this.getConsultWorkRequestForm().record.data.workOrderFullNumber;
        var idWorkOrder = this.getConsultWorkRequestForm().record.data.idWorkOrder;
        var me = this;
        Ext.Msg.show({
    ...
    validCompleteClosable: function(){
        var me = this;
        var message = '';
        var record = this.getConsultWorkRequestForm().getRecord();
        var scheduledActivityStore = Ext.getCmp('activityClosableOtGrid').getStore();
        var activityStore = Ext.getCmp('newActivityGrid').getStore();
        var scheduledProductStore = Ext.getCmp('workOrderScheduledProductGrid').getStore(); 
        var productStore = Ext.getCmp('workOrderProductGrid').getStore(); 
