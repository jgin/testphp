...
use JASoft\Hrm\PayrollBundle\Entity\Person;
use JASoft\Hrm\PayrollBundle\Form\PersonType;
...
class PersonController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('JASoftHrmPayrollBundle:Person')->findAll();
     ...
     * @Method("POST")
     * @Template("JASoftHrmPayrollBundle:Person:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('JASoftHrmPayrollBundle:Person')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("JASoftHrmPayrollBundle:Person:edit.html.twig")
     */
